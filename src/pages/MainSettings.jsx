...
import { Grid, FormControl, Box, useMediaQuery } from "@mui/material";
import {
  StyledInputBase,
  StyledInputLabel,
} from "../components/common/StyledComponents.jsx";
...
import {
  getMainSettings,
  updateMainSettings,
} from "../services/setting-api-service.js";
import {
  deleteImage,
  getImageSrc,
  uploadImage,
...
const MainSettings = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const payload = Object.entries(payloadData)
      .map(([key, value]) => {
            ...
            <Grid item xs={12} md={6}>
              <Grid container spacing={2} direction="column">
                <Grid item xs={12}>
                  ...
                  {errors.siteName && (
                    <ErrorMessage
                      type={errors?.siteName?.type}
                      maxLength={
                        errors?.siteName?.type === "maxLength" ? 20 : undefined
                      }
                    />
                  )}
                </Grid>
                  ...
                  >
                    ...
                    <StyledInputBase
                      ...
                      {...register("contactPhone", {
                        pattern: REGULAR_EXPRESSIONS.PHONE,
                      })}
                    />
                  </FormControl>
                  {errors.contactPhone && (
                    <ErrorMessage
                      type={errors?.contactPhone ? "phonePattern" : undefined}
                    />
                  )}
                </Grid>
                <Grid item xs={12}>
                  ...
                  {errors.contactMail && (
                    <ErrorMessage
                      type={errors?.contactMail ? "emailPattern" : undefined}
                    />
                  )}
                </Grid>
              </Grid>
                ...
                <ImageCard
                  ...
                  onClickDelete={() => {
                    setValue("favicon", null);
									...
									customDivideBy={isDesktop? 8 : isMedium? 5 : 2.5}
                />
                <ImageUploader
                  id="mainImageUploader"
									buttonDisabled={favicon}
                  ratio={1 / 1}
                  onChange={async (file) => {
                    if (file) {
          ...
          <Grid item>
            ...
            >
              ...
              <StyledInputBase
                ...
                {...register("geoLocation.url", {
                  required: false,
                  pattern: REGULAR_EXPRESSIONS.LINK,
                })}
              />
            </FormControl>
            {errors?.geoLocation?.url && (
              <ErrorMessage
                type={errors?.geoLocation?.url ? "urlPattern" : undefined}
              />
            )}
          </Grid>
          <Grid item>
            ...
            {errors?.geoLocation?.address && (
              <ErrorMessage type={errors?.geoLocation?.address.type} />
            )}
          </Grid>
          <Grid item>
            <FormControl
            ...
            >
              ...
              <StyledInputBase
                ...
                {...register("mediaLinks.instagramUrl", {
                  required: false,
                  pattern: REGULAR_EXPRESSIONS.LINK,
                })}
              />
            </FormControl>
            {errors?.mediaLinks?.instagramUrl && (
              <ErrorMessage
                type={
                  errors?.mediaLinks?.instagramUrl ? "urlPattern" : undefined
                }
              />
            )}
          </Grid>
          <Grid item>
            ...
            >
              ...
              <StyledInputBase
                ...
                id="facebookUrlInput"
                {...register("mediaLinks.facebookUrl", {
                  required: false,
                  pattern: REGULAR_EXPRESSIONS.LINK,
                })}
              />
            </FormControl>
            {errors?.mediaLinks?.facebookUrl && (
              <ErrorMessage
                type={
                  errors?.mediaLinks?.facebookUrl ? "urlPattern" : undefined
                }
              />
            )}
          </Grid>
