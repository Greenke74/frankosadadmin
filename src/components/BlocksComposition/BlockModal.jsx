...
import { Alert, Button, Modal, Typography, useMediaQuery } from "@mui/material";
    ...
    <>
      ...
      >
        ...
        >
          ...
          {allowedBlocks.map((blockType) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Typography sx={{ flexGrow: 1 }}>{b.label}</Typography>
                  <ArrowBackIcon
                    style={{
                      flexBasis: "20%",
                      color: "var(--theme-color)",
          ...
          <Box
            sx={{ display: "flex", justifyContent: "end", mt: 3, gap: "25px" }}
          >
            <CancelButton
              onClick={() => {
                onClose();
